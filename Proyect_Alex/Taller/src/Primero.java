...
public class Primero {
    ...
    public static void main(String[] args) {
        ...
        if (num1 <= 5) {
            ...
            total = total_U - total;
            System.out.println("Vas a comprar " + num1 + " y el precio de cada unidad es: " + "U$" + valor + " y el total de la compra con el descuento del 10% es: " + total);
        } else if (num1 <= 10) {
            int valor = 500;
            total_U = valor * num1;
            total = (total_U * 20) / 100;
            total = total_U - total;
            System.out.println("Vas a comprar " + num1 + " y el precio de cada unidad es: " + "U$" + valor + " y el total de la compra con el descuento del 20% es: " + total);
        } else {
            int valor = 500;
            total_U = valor * num1;
            total = (total_U * 40) / 100;
            total = total_U - total;
            System.out.println("Vas a comprar " + num1 + " y el precio de cada unidad es: " + "U$" + valor + " y el total de la compra con el descuento del 40% es: " + total);
        }
...
//CUAL ES LA DIFERENCIA ENTRE OP1++ Y ++OP1
